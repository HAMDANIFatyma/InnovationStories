...
from ..models import Cases, Teacher, School, User,  Comment, SummaryHistory
from django.views.generic import CreateView, ListView, UpdateView
from ..forms import  TeacherSignUpForm, CommentForm, StorieForm
...
def DeleteView(request, pk):
    try:
           quiz = get_object_or_404(Cases, pk=pk).delete()
    except quiz.DoesNotExist:
            raise Http404('cases does not exist')

    return render(request, 'classroom/teachers/board/tables-basic.html' )
