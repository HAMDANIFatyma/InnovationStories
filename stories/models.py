...
class Cases(models.Model):
    ...
    # Produit
    produit = models.CharField(max_length=100000,verbose_name=u"Le produit ", help_text=u"help text...", null=True)
    ...
    date = models.CharField(max_length=100000,verbose_name=u"Date", help_text=u"help text...", null=True)
    ...
    description= RichTextField(max_length=100000, null=True, verbose_name=u"Description du produit", help_text=u"help text...")
    ...
    diagnostic = RichTextField(max_length=100000, verbose_name=u"Diagnostic de la nouveauté", help_text=u"help text...", null=True)
    ...
    processus_name = models.CharField(max_length=255, verbose_name=u"Process-title ", help_text=u"Make your title attention-grabbing and informative.", null=True, blank=True)
    ...
    # fin 
    reference= RichTextField(max_length=100000, null=True,verbose_name=u"Références", help_text=u"help text...")
    abstract= RichTextField(max_length=100000, null=True,verbose_name=u"Abstract", help_text=u"help text...")
